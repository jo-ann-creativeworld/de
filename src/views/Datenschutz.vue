<template>
  <div class="min-h-screen py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
      <div class="bg-white/80 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-gray-200">
        <h1 class="text-4xl font-fredoka font-bold text-gray-800 mb-8">
        ...
        <div class="space-y-8 font-comic text-gray-700">
          ...
          <section>
            ...
            <p>
              Auf dieser Website sind Links zu unseren Social-Media-Profilen (LinkedIn, Instagram) 
              eingebunden. Wenn Sie auf diese Links klicken, werden Sie zu den externen Plattformen 
              weitergeleitet. Bitte beachten Sie die Datenschutzerklärungen der jeweiligen Anbieter:
            </p>
            <ul class="list-disc list-inside mt-2 space-y-1">
              <li>
                LinkedIn: 
                <a href="https://www.linkedin.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" class="text-sunny-yellow-600 hover:text-sunny-yellow-700 ml-1">
                  https://www.linkedin.com/legal/privacy-policy
                </a>
              </li>
              <li>
                Instagram: 
                <a href="https://help.instagram.com/519522125107875" target="_blank" rel="noopener noreferrer" class="text-sunny-yellow-600 hover:text-sunny-yellow-700 ml-1">
